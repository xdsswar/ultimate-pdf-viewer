package com.xss.it.nfx.svg.scene;
...
/**
 * Internal bottom layer of an {@code SvgView}: shows the rendered SVG bitmap.
 *
...
public final class RenderLayer extends Region {
    ...
    public RenderLayer() {
        ...
        getStyleClass().add("svg-render-layer");
    }

    /**
     * Sets (or clears) the displayed image.
     *
